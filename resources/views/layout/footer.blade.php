<footer class="bg-page-500 py-4 relative z-10 px-6">
    <div class="container">
        <div class="flex flex-wrap md:justify-between justify-evenly">
            <span class="inline-flex items-center text-xl text-dark-2">
    ...
    <div>
        ...
        <span class="absolute right-12 top-3 z-[-1]">
