...
<header x-data="{ navbarOpen: false }"
    class="fixed left-0 top-0 z-50 bg-gray-200 w-full flex items-center shadow-md dark:bg-gray-800 h-32">
        ...
        <div class="flex items-center justify-between -mx-4">
            <div class="pr-4 w-60 max-w-full">
                <a href="/" class="flex items-center w-full py-2 ">
                    ...
                    <img src="{{ url('img/logo.png') }}" alt="logo"
                        class="min-w-[150px] lg:min-w-[200px] sm:dark:inline-block hidden">
                </a>
            </div>
            <div class="flex justify-end items-center w-full px-6">
                ...
                <nav :class="!navbarOpen && 'hidden'" id="navbarCollapse"
                    class="absolute left-0 top-[90%] bg-gray-200 py-6 px-6 z-50 shadow rounded-lg w-[100svw] dark:bg-gray-800 dark:text-[#d9d9d9] lg:px-0 lg:max-w-full lg:block lg:w-full lg:right-4 lg:static lg:shadow-none">
